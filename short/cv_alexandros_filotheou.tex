...
\begin{center}
  {\small Thessaloniki, Greece $|$ \href{mailto:alexandros.filotheou@gmail.com}{alexandros.filotheou@gmail.com} $|$ (+30) 693 8787 677 $|$ \href{https://www.linkedin.com/in/alexandros-filotheou-5b6a8676/}{linkedin.com/in/alexandros-filotheou} \\
   \href{https://mozilla.github.io/pdf.js/web/viewer.html?file=https://raw.githubusercontent.com/li9i/portfolio/master/portfolio.pdf}{Portfolio} $|$  \href{https://scholar.google.com/citations?hl=en&user=9_hI4hMAAAAJ&view_op=list_works}{scholar.google.com/alexandros-filotheou} \\
\href{https://github.com/li9i/}{\texttt{github.com/li9i}}
   \\}\vspace{1em}
\end{center}
...
\section{\textbf{Experience}}\verticalspacebetweensectionandcontent
  ...
  \noindent\textbf{Robotics Software Engineer} $\cdot$ ITI-CERTH, Thessaloniki GR \hfill {\small \textcolor{datecolour}{Sep $2023$ -- Present}} \\
  ...
  \begin{minipage}[t]{\textwidth}
    \begin{itemize}
      ...
      \item Deployed tactile- and voice-interactive \href{https://www.youtube.com/watch?v=mrTL3Gep7Xk&t=36s}{human-robot applications} at \href{https://www.amth.gr/en}{AMTh} museum, engaging $2,000$+ visitors annually since $2023$ with Tkinter and Rasa \verticalspaceafteritem

...
\usepackage[top=10mm, bottom=1mm, inner=0.75in, outer=0.75in, footskip=20mm]{geometry}
...
% A line
% \begin{center}\noindent\rule{0.382\textwidth}{0.4pt}\end{center}

\usepackage{hyperref}
\definecolor{linkcolour}{rgb}{0,0.2,0.6} % Link color
\definecolor{datecolour}{rgb}{0.4,0.4,0.4} % Colour of dates

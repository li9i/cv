...
\begin{bw_box}
  ...
  general integration and problem-solving. These I have acquired in real
  conditions with \href{https://relief.web.auth.gr/\%CF\%81\%CE\%BF\%CE\%BC\%CF\%80\%CE\%BF\%CF\%84\%CE\%B9\%CE\%BA\%CE\%AC-\%CE\%BF\%CF\%87\%CE\%AE\%CE\%BC\%CE\%B1\%CF\%84\%CE\%B1/}{real robots} as well as in simulation. I have mainly used ROS
  ...
  or \href{https://github.com/li9i/ros1_humble_bridge_template}{tutorials}.
\end{bw_box}

...
\usepackage[top=30mm, bottom=1mm, inner=30mm, outer=30mm, footskip = 20mm]{geometry}
...
Tools & \texttt{git}, \texttt{OpenCV}, \texttt{Docker}, \texttt{Qt (cpp)} | \texttt{Tkinter (py)}, \LaTeX\\
\end{tabular}
...
\begin{tabular}{rp{12cm}}
  English & Fluent --- IELTS Score $8.5$ (Greek Native) \vspace{0.3cm}
\end{tabular}

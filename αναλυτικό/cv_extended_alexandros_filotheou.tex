...
Τρέχουσα τοποθεσία \& Ηλικία & Λούβαιν, Βέλγιο | $39$ \\
...
Συμπυκνωμένη έκδοση βιογραφικού & \href{https://docs.google.com/viewerng/viewer?url=https://raw.githubusercontent.com/li9i/CV/master/compact/cv_compact_alexandros_filotheou.pdf}{Στο \texttt{github}} \\
Ενδεικτικά πακέτα λογισμικού: &
\href{https://index.ros.org/p/hitch_estimation_apriltag_array/#humble}{\texttt{hitch\_estimation\_apriltag\_array}} $\cdot$
\href{https://index.ros.org/p/pointcloud_to_ply/#humble}{\texttt{pointcloud\_to\_ply}} \\
...
Demos / videos: &
    Integration \href{https://www.youtube.com/shorts/TSIXd5L-Hxk}{[1]} $\cdot$
    \href{https://www.youtube.com/watch?v=ViU-9DLi2-M}{[2]} $\cdot$
    \href{https://www.youtube.com/watch?v=xuIbOL-MPRk\&t=10s}{[3]}\\
    &
    \href{https://youtu.be/bo4lMI640DY?t=10}{SLAM/Navigation}  $\cdot$
    \href{https://cultureid.web.auth.gr/?page\_id=200\&lang=en}{Museum Robot}  $\cdot$
    \href{https://www.youtube.com/watch?v=937OZez1iN8}{Control is Fun} \\
    &
\href{https://www.youtube.com/watch?v=xaDKjI0WkDc}{\texttt{cbgl}} $\cdot$ \href{https://cultureid.web.auth.gr/?page\_id=200&lang=en}{\texttt{cultureid}} $\cdot$ \href{https://www.youtube.com/watch?v=hB4qsHCEXGI}{\texttt{fsm}} $\cdot$ \href{https://relief.web.auth.gr/}{\texttt{relief}} \\
...
\begin{tabular}{rp{12cm}}
%------------------------------------------------
02.2026 - \hfill Παρόν \hfill & \textbf{Senior Robotics Software Engineer} \\
                              &  Intermodalics BV, Leuven, Belgium \\
&\\
09.2023 - \hfill 01.2026 \hfill & \textbf{Μεταδιδακτορικός Ερευνητής} \\
...
$2023.09 - 2026.01$ & \href{https://www.robetarme-project.eu/}{\textbf{RoBétArmé}} \\

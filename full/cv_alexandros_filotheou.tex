...
Current location and Date of CV update  & Thessaloniki, Greece | April 2025 \\
...
$2018.09 - 2021.08$ & \href{https://relief.web.auth.gr/}{\textbf{RELIEF}} \\
                    ...
                    & Development of ROS packages for mapping, localisation, navigation, and visualisation (Qt). Integration onto two mobile platforms (Turtlebot \& Robotnik RB1). Integration of RFID-related factory- and custom-built software and wrapping into ROS. General software and hardware troubleshooting and integration. Work with 2D LIDARs, RGBD cameras, RFID readers. Documentation. \\
&\\
$2020.04 - 2023.03$ & \href{https://cultureid.web.auth.gr/?page\_id=216\&lang=en}{\textbf{CULTUREID}} \\
                    & \textit{Aristotle University of Thessaloniki, Greece}\\
                    & \textit{Electrical and Computer Engineering Department} \\
                    & Development of ROS packages for mapping, localisation, navigation, visualisation (Tkinter). Integration onto one mobile platform (Turtlebot). Integration of RFID-related factory- and custom-built software and wrapping into ROS. General software and hardware troubleshooting and integration. Work with 2D LIDARs, RGBD cameras, RFID readers. Documentation. \\
&\\
$2023.09 - \text{present}$ & \href{https://www.robetarme-project.eu/}{\textbf{ROBETARME}} \\
                           & \textit{Center for Research and Technology Hellas (CERTH), Thessaloniki, Greece}\\
                           & Development of ROS packages for planning, scheduling, orchestrating and triggering ROS Noetic and ROS 2 Humble packages and other software and integation with Behaviour Trees. Integration onto two mobile platforms (ROBOTNIK RBVOGUIs). Integration of in-house and third ROS Noetic and ROS 2 Humble packages. Work with 3D LIDARs, RGBD cameras. Translation of custom interfaces between ROS 1 and ROS 2. Network configuration and troubleshooting for ROS 2 via DDS, Zenoh. Virtualisation via Docker. General software and hardware troubleshooting and integration. Documentation. \\
&\\
\end{tabular}
...
\vfill
{\noindent
  \small Thessaloniki, Greece; July 2024  \hfill contact: (+30) 693 87 87 677 $|$ alexandros.filotheou@gmail.com

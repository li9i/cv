...
author={Filotheou, Alexandros},
booktitle={Accepted in 2024 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)},
...
\begin{bw_box}
  ...
  I have 7+ years of hands-on experience which includes SLAM, \href{https://github.com/li9i/fsm-lo}{localisation},
  \href{https://link.springer.com/article/10.1007/s10846-019-01086-y}{autonomous navigation}, control,
  ...
  conditions with real robots} as well as in simulation. I have mainly used ROS
  and ROS 2, but also MATLAB/Octave, all the while under Linux. My primary
  coding language is \href{https://github.com/li9i/fsm}{C++} and my secondary
  \href{https://github.com/cultureid-auth-ros-packages/cultureid-waypoints-following}{Python}.
  I enjoy documenting my motivation and contributions in a clear and concise
...
Current location and Date of CV update  & Thessaloniki, Greece | July 2024 \\
...
&\\
$2018.09 - 2023.03$ & \textbf{Robotics Researcher} for NSRF projects \\
...
$2011.03 - 2011.05$ & \textbf{Application Developer} \\
